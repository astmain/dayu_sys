...
export class orm1_create extends OmitType(Base, ['id']) {
}

export class orm1_del extends PickType(Base, ['id']) {
}

export class orm1_update extends Base {
}

export class orm1_find extends PickType(Base, ['name']) {
}
