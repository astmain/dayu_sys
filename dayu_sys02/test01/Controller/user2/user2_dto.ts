...
export class create extends user2_dto {
}


export class find extends PickType(user2_dto, ['name', 'age']) {
}


export class del extends PickType(user2_dto, ['id']) {
}
