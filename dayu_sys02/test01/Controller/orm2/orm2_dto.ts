...
export class orm2_create extends OmitType(Base, ['id']) {
}

export class orm2_del extends PickType(Base, ['id']) {
}

export class orm2_update extends Base {
}

export class orm2_find extends PickType(Base, ['name']) {
}
