 ...
 * @returns
 */
export function test1__create({ name, age }) {
    return axios.post(`/test1/create`, { name, age });
}
 ...
 * @returns
 */
export function test1__remove(id) {
    return axios.delete(`/test1/${id}`);
}
 ...
 * @returns
 */
export function test1__update(id, { name, age }) {
    return axios.put(`/test1/${id}`, { name, age });
}
 ...
 * @returns
 */
export function test1__findOne(id) {
    return axios.get(`/test1/${id}`);
}
 ...
 * @returns
 */
export function test1__findAll() {
    return axios.get(`/test1`);
}
