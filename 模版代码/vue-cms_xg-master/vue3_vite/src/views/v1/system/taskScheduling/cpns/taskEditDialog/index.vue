          ...
          <Loading style="margin:0px" :isLoading="loading">
            <div class="scroll-bar-style" style="height:calc(100vh - 250px);">
                <FormList v-model="formModel" ref="formRef" :formConfig="formConfig" >
                    <template #picId>
                        <div @click="handleShowPicListDialog(picListDialogRef,formModel.picId)" style="cursor:pointer">
...
<script setup lang="ts">
    ...
    import {formConfig} from "@/views/article/articleList/cpns/artEditDialog/config/formConfig";
    import {mdEditorToolbarsConfig} from "../config/index"
    import FormList from '@/components/formList'
    import MdEditor from 'md-editor-v3';
    import 'md-editor-v3/lib/style.css';
    import {useFunc} from "@/views/article/articleList/cpns/artEditDialog/hooks/useFunc";
    ...
    import type {exposeInterface} from "@/views/system/taskScheduling/cpns/taskEditDialog/types";
    ...
    let {handleOpenDialog,handleResetForm,handleEditSubmit,handleCancel,picListDialogRef,formRef,dialogFullscreen,model,dialogShow,loading,dialogTitle,key,formModel,artContentImgUploadArr} = useFunc()
