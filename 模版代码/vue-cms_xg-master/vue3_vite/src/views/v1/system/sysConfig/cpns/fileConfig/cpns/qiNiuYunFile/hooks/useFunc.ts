...
import {formInit} from "@/views/system/sysConfig/cpns/fileConfig/cpns/qiNiuYunFile/config/formConfig";
...
export const useFunc = ()=>{
    ...
    const handleSubmit = async (formRef:InstanceType<typeof FormList>)=>{
        ...
        loading.value=true;
        let form:any = {
            key:sysConfigEnum.qiNiuYunFile,
