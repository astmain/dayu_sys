  ...
  <Loading :isLoading="loading">
    <FormList v-model="formModel" ref="formRef" :formConfig="formConfig">
      <template #formCustomBtn>
        <el-button type="primary" :loading="loading" v-if="handleCheckPower(['system:sysConfig:fileConfig:qiNiuYunFile'])" @click.native.prevent="handleSubmit(formRef)">{{$t("btn.update")}}</el-button>
