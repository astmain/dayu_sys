...
import {requestErrorLog} from "@/network/system/logManage/errorLog";
import {requestCleanErrorLog} from "@/network/system/logManage/errorLog/index";
import {onMounted, onUnmounted, ref} from "vue"
import {useStore} from "@/store/piniaAutoImport";
import {isArray} from "@/utils/lodash";
import FormList from "@/components/formList";
import TableList from "@/components/tableList";
import OperationDetailDialog from "../cpns/operationDetailDialog/index.vue"

export const useFunc = () =>{
    let formRef = ref<InstanceType<typeof FormList>>()
    let tableListRef = ref<InstanceType<typeof TableList>>(null)
    let operationLogRef = ref<InstanceType<typeof OperationDetailDialog>>()
    ...
    const handleList = () => {
        ...
        return requestErrorLog(form).then((res: any) => {
    ...
    return {
        handleTableSelectionChange,handleList,handleSearch,handleReset,handleSizeChange,handleCurrentChange,handleDelete,handleClean,handleFormChange,handleRequestParamsToObj,
        formRef,tableListRef,operationLogRef,settingStore,multiple,dialogShow,dialogTitle,key,formSearchModel,formConfig,pageConfig,tableConfig,loading
    }
}