...
<script setup lang="ts">
    ...
    import type {exposeInterface} from "@/views/common/personalCenter/cpns/notify/cpns/noticeDetailDialog/types";
    ...
    let {handleOpenDialog,handleCancel,formRef,model,dialogShow,loading,dialogTitle,key,formModel,handleChangeNoticeStatus} = useFunc(emit)
