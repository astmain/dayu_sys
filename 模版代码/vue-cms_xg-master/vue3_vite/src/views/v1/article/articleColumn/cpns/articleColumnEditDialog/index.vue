...
<script setup lang="ts">
    ...
    import {useFunc} from "@/views/article/articleColumn/cpns/articleColumnEditDialog/hooks/useFunc";
    import type {propsInterface} from "@/views/article/articleColumn/cpns/articleColumnEditDialog/types";
    import {exposeInterface} from "@/views/article/articleColumn/cpns/articleColumnEditDialog/types";
    ...
    let {handleOpenDialog,handleEditSubmit,handleResetForm,handleCancel,formRef,dialogShow,loading,key,dialogTitle,formModel}  = useFunc()
