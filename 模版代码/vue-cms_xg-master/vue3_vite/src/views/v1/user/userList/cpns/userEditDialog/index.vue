...
<script setup lang="ts">
    ...
    import type {propsInterface,exposeInterface} from "@/views/user/userList/cpns/userEditDialog/types";
    ...
    let {handleOpenDialog,handleResetForm,handleEditSubmit,handleCancel,picListDialogRef,formRef,model,dialogShow,loading,dialogTitle,key,formModel,roleOptions} = useFunc()
